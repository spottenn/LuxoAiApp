...
setup_android_sdk() {
  ...
  yes | sdkmanager --licenses --sdk_root="$ANDROID_HOME" || echo "License acceptance may have had issues, continuing..."
...
main() {
  ...
  setup_java
  setup_gradle # Check gradle early, as sdkmanager might be packaged with android studio which includes gradle
  setup_android_sdk
